...
one at tier 2, Merling's base water breathing gives way to the Ascended Conduit,
and Abyssal and Verdant do the same at apex. Those swaps cost the player nothing
and leave no gap, which is why they are not tabulated. Read the origin's JSON if
