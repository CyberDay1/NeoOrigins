...
class OptionalFieldOmissionTest {
    ...
    private static final class Host implements CreatorHost {
        @Override public <T extends AbstractWidget> T register(T w) { return w; }
        @Override public <T extends AbstractWidget> T registerInputOnly(T w) { return w; }
    ...
    private static FormFieldSpec child(String powerId, String objectField, String childName) {
        FormFieldSpec obj = field(FormModel.forPower(Identifier.parse(powerId)), objectField);
