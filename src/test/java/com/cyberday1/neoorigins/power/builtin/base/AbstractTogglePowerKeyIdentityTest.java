...
class AbstractTogglePowerKeyIdentityTest {
    ...
    private static final ResourceLocation POWER_A = ResourceLocation.parse("mypack:flight_a");
    ...
    void wraithPhaseOverridesTheIdTakingFormOfIsToggledOff() {
        assertDoesNotThrow(() -> WraithPhasePower.class.getDeclaredMethod(
            "isToggledOff", ServerPlayer.class, WraithPhasePower.Config.class, ResourceLocation.class));
    }
}
