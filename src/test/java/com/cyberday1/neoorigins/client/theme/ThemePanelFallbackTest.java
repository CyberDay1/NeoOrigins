...
class ThemePanelFallbackTest {
    ...
    private static final Identifier ID = Identifier.parse("mypack:my_theme");
    private static final Identifier PANEL = Identifier.parse("mypack:textures/gui/themes/my_theme/panel.png");
    ...
    private static UITheme load(boolean panelExists) {
        ...
        Map<Identifier, JsonElement> map = Map.of(ID, JsonParser.parseString(JSON));
