 ...
 *
 * <p>REI is compile-only. Its 26.2 line ({@code 26.2.821}, which declares
 * {@code minecraft [26.2,)}) pulls {@code cloth-config-neoforge 26.2.155} and
 * {@code architectury-neoforge 21.0.2} onto the compile classpath transitively;
