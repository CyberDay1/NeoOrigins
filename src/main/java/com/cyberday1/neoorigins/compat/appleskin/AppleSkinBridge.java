 ...
 * {@link NeoOrigins} - it is never class-loaded when AppleSkin is absent, which
 ...
 * every diet-override origin (aquatic fish diets, Caveborn, vampire, ...), so the
 * hook is written generically off the power rather than special-cased to fish.
 *
 ...
 * ({@code SyncFoodNutritionPayload} → {@link ClientFoodNutrition}).
 *
