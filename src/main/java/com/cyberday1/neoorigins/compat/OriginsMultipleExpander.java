...
public final class OriginsMultipleExpander {
     ...
     *        contain underscores).
     */
    private static Map<ResourceLocation, JsonObject> expand(ResourceLocation id, String legacyPath, JsonObject src) {
        ...
        for (Map.Entry<String, JsonElement> entry : src.entrySet()) {
            ...
            if (isMultipleType(subType)) {
                try {
                    Map<ResourceLocation, JsonObject> nested =
     ...
     */
    public static Map<ResourceLocation, JsonObject> expandAttributeMulti(ResourceLocation id, JsonObject src) {
     ...
     */
    private static JsonObject buildDisplay(ResourceLocation id, String legacyPath, JsonObject src) {
