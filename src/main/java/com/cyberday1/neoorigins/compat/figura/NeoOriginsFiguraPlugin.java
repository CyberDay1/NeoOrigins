 ...
 * references never resolve — no {@code NoClassDefFoundError}. On this 26.2 branch
 * Figura publishes no artifact, so the module compiles against the hand-written
 * {@code src/apistubs/java/org/figuramc/figura} stub (compile classpath only,
 * never bundled); it is NOT listed in neoforge.mods.toml dependencies.
 *
