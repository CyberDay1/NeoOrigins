...
public final class ItemActionParser {
     ...
     * Matching is by {@link net.minecraft.resources.Identifier}, resolved off
     * the holder already on the stack, which is what lets this work without a
     * registry lookup - the same approach {@code ItemConditionParser}'s
    ...
    private static boolean matchesAny(
            ...
            java.util.Collection<net.minecraft.resources.Identifier> ids) {
        // 26.x renamed ResourceKey#location to ResourceKey#identifier, in step
        // with ResourceLocation becoming Identifier.
