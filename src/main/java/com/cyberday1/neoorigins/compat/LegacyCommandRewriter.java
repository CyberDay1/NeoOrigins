...
public final class LegacyCommandRewriter {
    ...
    /**
     * Mark every character that sits inside a quoted string, quotes included.
     * Both SNBT quote characters count, and a backslash escapes the next
     * character. An <em>unbalanced</em> quote marks everything after it, which
     * is the safe direction: the rewrite skips it.
     */
