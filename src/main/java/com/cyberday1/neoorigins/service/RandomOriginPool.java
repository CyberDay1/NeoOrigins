...
public final class RandomOriginPool {
    ...
    public static List<Identifier> of(OriginLayer layer, Collection<Identifier> candidates,
                                            Predicate<Identifier> blocked) {
    ...
    public static Identifier pick(List<Identifier> pool, IntUnaryOperator nextInt) {
