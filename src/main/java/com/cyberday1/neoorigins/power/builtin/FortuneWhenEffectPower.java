...
public class FortuneWhenEffectPower extends PowerType<FortuneWhenEffectPower.Config> {
    ...
    private static final ResourceLocation DEFAULT_EFFECT =
        ResourceLocation.fromNamespaceAndPath("minecraft", "luck");
    ...
    public record Config(
        ...
        public static final Codec<Config> CODEC = RecordCodecBuilder.create(inst -> inst.group(
            ResourceLocation.CODEC.optionalFieldOf("effect", DEFAULT_EFFECT).forGetter(Config::effect),
