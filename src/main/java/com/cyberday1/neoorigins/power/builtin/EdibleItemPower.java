...
public class EdibleItemPower extends PowerType<EdibleItemPower.Config> {
    ...
    public record Tier(
        ...
        public static final Codec<Tier> CODEC = RecordCodecBuilder.create(inst -> inst.group(
            ResourceLocation.CODEC.listOf().optionalFieldOf("items", List.of()).forGetter(Tier::items),
            ResourceLocation.CODEC.listOf().optionalFieldOf("tags", List.of()).forGetter(Tier::tags),
    ...
    private static boolean matchesAny(ItemStack stack, List<ResourceLocation> items, List<ResourceLocation> tags) {
