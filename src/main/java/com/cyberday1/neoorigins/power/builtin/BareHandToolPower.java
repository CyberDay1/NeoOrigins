...
public class BareHandToolPower extends PowerType<BareHandToolPower.Config> {
    ...
    private static final ResourceLocation DEFAULT_TOOL =
        ResourceLocation.fromNamespaceAndPath("minecraft", "stone_pickaxe");

    public record Config(ResourceLocation tool, String type) implements PowerConfiguration {
        public static final Codec<Config> CODEC = RecordCodecBuilder.create(inst -> inst.group(
            ResourceLocation.CODEC.optionalFieldOf("tool", DEFAULT_TOOL).forGetter(Config::tool),
