...
public class NightVisionPower extends PowerType<NightVisionPower.Config> {
    ...
    public void onTick(ServerPlayer player, Config config) {
        // Apply with high duration to prevent the flash effect (reapply well before it expires)
