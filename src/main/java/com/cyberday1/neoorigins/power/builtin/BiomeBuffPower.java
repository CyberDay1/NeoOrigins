...
public class BiomeBuffPower extends PowerType<BiomeBuffPower.Config> {
    ...
    public record Config(ResourceLocation biomeTag, ResourceLocation effect, int amplifier, String type)
    ...
    public void onTick(ServerPlayer player, Config config) {
        ...
        BuiltInRegistries.MOB_EFFECT.getOptional(config.effect()).ifPresent(effect -> {
