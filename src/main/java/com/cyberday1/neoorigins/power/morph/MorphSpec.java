...
public record MorphSpec(
    ...
    public static final Codec<MorphSpec> CODEC = RecordCodecBuilder.create(inst -> inst.group(
        ResourceLocation.CODEC.optionalFieldOf("entity_type").forGetter(MorphSpec::entityType),
    ...
    public void write(FriendlyByteBuf buf) {
        buf.writeOptional(entityType, FriendlyByteBuf::writeResourceLocation);
    ...
    public static MorphSpec read(FriendlyByteBuf buf) {
        Optional<ResourceLocation> entityType = buf.readOptional(FriendlyByteBuf::readResourceLocation);
