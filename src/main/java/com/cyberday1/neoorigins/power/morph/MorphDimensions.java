...
public final class MorphDimensions {
    ...
    private static final Set<Identifier> UNMEASURABLE = ConcurrentHashMap.newKeySet();
     ...
     */
    @Nullable
    private static EntityDimensions measure(Level level, MorphSpec spec, Identifier typeId) {
    ...
    private static void markUnmeasurable(Identifier typeId, String reason) {
