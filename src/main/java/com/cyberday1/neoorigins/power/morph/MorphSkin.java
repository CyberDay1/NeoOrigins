...
public record MorphSkin(
    ...
    public static final Codec<MorphSkin> CODEC = RecordCodecBuilder.create(inst -> inst.group(
        ResourceLocation.CODEC.optionalFieldOf("texture").forGetter(MorphSkin::texture),
        ResourceLocation.CODEC.optionalFieldOf("cape").forGetter(MorphSkin::cape),
        ResourceLocation.CODEC.optionalFieldOf("elytra").forGetter(MorphSkin::elytra),
     ...
     */
    public static ResourceLocation texturePath(ResourceLocation assetId) {
        return assetId.withPath(path -> "textures/" + path + ".png");
    }

    public void write(FriendlyByteBuf buf) {
        buf.writeOptional(texture, FriendlyByteBuf::writeResourceLocation);
        buf.writeOptional(cape, FriendlyByteBuf::writeResourceLocation);
        buf.writeOptional(elytra, FriendlyByteBuf::writeResourceLocation);
