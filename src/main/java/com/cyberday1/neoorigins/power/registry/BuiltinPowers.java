...
public final class BuiltinPowers {
     ...
     * three editors' forms and the doc reference tables.
     *
    ...
    static {
        ...
        define("bounce_on_land", BounceOnLandPower.class, List.of(
            ...
            new FieldSpec("min_velocity", Kind.NUMBER, false)
                .def(0.63).doc("Minimum downward speed (blocks/tick) needed to trigger a bounce, so jumps and short drops don't micro-bounce; 0.63 is the floor a 4-block fall clears and a 3-block fall does not (default 0.63)."),
        ...
        // component (render_armor, default true) — registers as one BOOLEAN field.
        ...
        //     the switch from the schema and all three editors (and left a
        //     standing un-specced-component WARN).
