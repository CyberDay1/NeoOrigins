...
public record EntityTargetSpec(
    ...
    public static final Codec<EntityTargetSpec> CODEC = RecordCodecBuilder.create(inst -> inst.group(
        ResourceLocation.CODEC.optionalFieldOf("entity_type").forGetter(EntityTargetSpec::entityType),
        ResourceLocation.CODEC.optionalFieldOf("entity_tag").forGetter(EntityTargetSpec::entityTag),
        ResourceLocation.CODEC.listOf().optionalFieldOf("entity_types", List.of())
