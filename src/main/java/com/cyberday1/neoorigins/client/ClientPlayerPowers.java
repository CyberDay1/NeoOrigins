...
public final class ClientPlayerPowers {
     ...
     */
    public static Identifier primaryOrigin(UUID playerId) {
        Entry e = BY_PLAYER.get(playerId);
        if (e == null) return null;
        Identifier origin = e.origins().get(
    ...
    public static List<Identifier> origins(UUID playerId) {
        Entry e = BY_PLAYER.get(playerId);
    ...
    public static Map<Identifier, Identifier> originsByLayer(UUID playerId) {
        Entry e = BY_PLAYER.get(playerId);
        return e == null ? Map.of() : e.origins();
    }

    /** True if the player has {@code powerId} granted, regardless of toggle state. */
    public static boolean hasPower(UUID playerId, Identifier powerId) {
     ...
     */
    public static boolean isPowerActive(UUID playerId, Identifier powerId) {
    ...
    public static List<Identifier> powers(UUID playerId) {
