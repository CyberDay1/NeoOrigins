 ...
 * position before setting the problem, so the player gets the anchor
 * benefit without the time-skip / sleep animation.
 */
...
public final class SleepPreventionEvents {
    ...
    public static void onCanSleep(CanPlayerSleepEvent event) {
        ...
        sp.sendSystemMessage(Component.literal("You don't need sleep."));
    }
