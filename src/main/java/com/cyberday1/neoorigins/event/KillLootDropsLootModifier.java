...
public final class KillLootDropsLootModifier extends LootModifier {
    ...
    public KillLootDropsLootModifier(LootItemCondition[] conditions) {
        super(conditions);
    }
    ...
    protected ObjectArrayList<ItemStack> doApply(ObjectArrayList<ItemStack> generatedLoot,
        ...
        //    back to KILLER_ENTITY only when it is itself a Player.
    ...
    private static Player resolveKiller(LootContext context) {
        ...
        // 1.21.1 has no KILLER_ENTITY param; ATTACKING_ENTITY is the entity that
        // dealt the killing blow. Use it only when it is itself a Player.
