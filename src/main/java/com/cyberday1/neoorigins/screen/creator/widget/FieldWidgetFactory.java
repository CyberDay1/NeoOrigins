...
public final class FieldWidgetFactory {
    ...
    private abstract static class Base implements FieldRow {
         ...
         */
        final void drawErrorLine(GuiGraphicsExtractor g, Font font, int labelX, int y) {
            String err = validationError();
            if (err == null) return;
            g.text(font, "✕ " + err, labelX + 4, y + errorLineDy(),
         ...
         * is not a parseable Identifier, else {@code null}.
         */
        static String idShapeError(String s) {
            String bare = s.startsWith("#") ? s.substring(1) : s;
            return net.minecraft.resources.Identifier.tryParse(bare) == null
    ...
    private static final class TextRow extends Base {
        ...
        @Override public String validationError() {
            ...
            // can't even parse as an Identifier would silently no-op at
