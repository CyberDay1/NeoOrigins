...
public final class PowersTab implements CreatorTab {
    ...
    private void buildForm(PowerDraft p, Font font) {
        Identifier type = parseType(p.typeId);
    ...
    private Identifier mintId(PowerDraft self) {
