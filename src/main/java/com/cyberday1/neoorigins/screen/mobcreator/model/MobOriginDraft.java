...
public final class MobOriginDraft {
    ...
    public ResourceLocation originId() {
        return ResourceLocation.fromNamespaceAndPath(OriginDraft.CUSTOM_NAMESPACE, idPath);
    }

    /** Mint a stable, collision-free power id — same scheme as OriginDraft. */
    public ResourceLocation mintPowerId(OriginDraft.PowerDraft self, String typeId) {
        String typeShort;
