...
public final class MobDropsTab implements MobCreatorTab {
    ...
    public void render(GuiGraphicsExtractor g, int mouseX, int mouseY, float partial,
        ...
        g.text(font, "Mode",     lx, top + Y_MODE_STRAT + 6, CreatorStyle.LABEL, false);
        g.text(font, "Strategy", x + w / 2 + 6, top + Y_MODE_STRAT + 6, CreatorStyle.LABEL, false);
        g.text(font, "Pool rolls",
        ...
        g.text(font, "item",   lx + 36, top + Y_COL_HEADERS, CreatorStyle.LABEL, false);
        g.text(font, "min",    countCol, top + Y_COL_HEADERS, CreatorStyle.LABEL, false);
        g.text(font, "max",    countCol + 30, top + Y_COL_HEADERS, CreatorStyle.LABEL, false);
        g.text(font, "chance", chanceCol, top + Y_COL_HEADERS,
            weighted ? CreatorStyle.TEXT_DIM : CreatorStyle.LABEL, false);
        g.text(font, "rolls",  rollsCol, top + Y_COL_HEADERS,
            weighted ? CreatorStyle.TEXT_DIM : CreatorStyle.LABEL, false);
        g.text(font, "weight", weightCol, top + Y_COL_HEADERS,
            weighted ? CreatorStyle.LABEL : CreatorStyle.TEXT_DIM, false);
