    ...
    static {
        ...
        SUN_HELMET_DURA_DAMAGE_CHANCE = BUILDER
            .comment("Per-evaluation chance (0.0 – 1.0) that a damageable helmet takes",
                     ...
                     "Fire-resistant helmets (the minecraft:damage_resistant",
                     "component covering fire — netherite in vanilla) ignore this",
                     "value and never wear out from sun protection, as do",
                     "unbreakable ones.",
