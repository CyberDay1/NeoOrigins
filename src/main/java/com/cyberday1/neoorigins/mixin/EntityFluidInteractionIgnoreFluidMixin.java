 ...
 *
 * <p><b>Tracker set varies by NeoForge build.</b> Below NeoForge 26.1.2.99
 ...
 * for it. From 26.1.2.99 NeoForge keys the trackers by {@code FluidType}, so
 ...
 * NeoForge 26.1.2.100 (the 26.1 backport of 26.2.0.69) moved the scan body into a new
 ...
 * the 26.1.2.100 fence. Matching both overloads wraps whichever one contains the scan
